...
<head>
    ...
    <title>Forget Password - Well Pharamcy</title>
                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="john@example.com" autofocus />
                                        @error('email')
